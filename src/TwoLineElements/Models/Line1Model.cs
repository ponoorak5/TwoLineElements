namespace TwoLineElements.Models
{
    ...
    public class Line1Model
    {
        ...
        /// <list type="bullet">
        /// <item><description>last two digits of launch year</description></item>
        /// <item><description>launch number of the year</description></item>
        /// <item><description>piece of the launch</description></item>
        /// </list>
        /// </summary>
        ...
        /// <a href="https://web.archive.org/web/20000301052035/http://spaceflight.nasa.gov/realdata/sightings/SSapplications/Post/JavaSSOP/SSOP_Help/tle_def.html">See tle def</a>
        /// </summary>
